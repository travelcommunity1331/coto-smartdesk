    ...
    <div className="flex h-screen w-full bg-slate-50 overflow-hidden text-slate-900">
      ...
      <main className="flex-1 flex flex-col h-full overflow-y-auto pb-20 md:pb-0">
        ...
        <div className="p-4 md:p-8 space-y-6">
           ...
           {/* LICENSE KEY WIDGET Ở ĐÁY DASHBOARD */}
           <div className="mt-12 bg-coto-dark text-white rounded-2xl p-8 max-w-3xl mx-auto shadow-2xl relative overflow-hidden border border-slate-700">
              ...
              <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
                 <div className="flex-1 text-center md:text-left">
                    <div className="inline-flex items-center gap-2 bg-white/10 px-3 py-1 rounded-full text-xs font-semibold text-coto-blue mb-4">
                       <Key size={14} /> KÍCH HOẠT BẢN QUYỀN
                    </div>
                    <h3 className="text-2xl font-bold mb-2">Phiên bản Dùng Thử</h3>
                    <p className="text-slate-400 text-sm">
                      Bạn đang sử dụng phiên bản giới hạn tính năng. Vui lòng nhập mã License Key được cấp để mở khóa toàn bộ quyền năng của hệ thống.
                    </p>
                 </div>
                 ...
                 <div className="w-full md:w-auto min-w-[300px]">
                    <div className="flex bg-white/5 rounded-lg border border-white/10 p-1 focus-within:border-coto-blue transition">
                       <input 
                         ...
                         placeholder="Nhập mã CODE-XXXXXX..."
                       ...
                       <button 
                         ...
                         className="bg-coto-blue text-white px-4 py-2 rounded-md text-sm font-bold shadow-sm hover:bg-coto-blue/90 disabled:opacity-50 transition"
                       >
